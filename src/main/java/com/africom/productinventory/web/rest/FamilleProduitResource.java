...
/**
 * REST controller for managing {@link com.africom.productinventory.domain.FamilleProduit}.
 */
@RestController
@RequestMapping("/api")
public class FamilleProduitResource {
    ...
    private static final String ENTITY_NAME = "productInventoryFamilleProduit";
