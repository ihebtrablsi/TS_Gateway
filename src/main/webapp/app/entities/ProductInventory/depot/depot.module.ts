...
@NgModule({
  imports: [TsGatewayAngSharedModule, RouterModule.forChild(depotRoute), DxDataGridModule, DxTemplateModule, DxiColumnModule],
...
export class ProductInventoryDepotModule {}
