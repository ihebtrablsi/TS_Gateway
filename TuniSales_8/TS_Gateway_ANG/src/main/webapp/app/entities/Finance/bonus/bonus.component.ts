...
export class BonusComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.bonusService
      ...
      .subscribe(
        (res: HttpResponse<IBonus[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IBonus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
