...
describe('Service Tests', () => {
  describe('Code Service', () => {
    ...
    let elemDefault: ICode;
    let expectedResult: ICode | ICode[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Code(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Code', () => {
        ...
        service.create(new Code()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Code', () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
          },
