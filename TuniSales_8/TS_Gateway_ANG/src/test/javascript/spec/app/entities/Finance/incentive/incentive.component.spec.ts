...
import { IncentiveComponent } from 'app/entities/Finance/incentive/incentive.component';
...
describe('Component Tests', () => {
  describe('Incentive Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.incentives && comp.incentives[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
