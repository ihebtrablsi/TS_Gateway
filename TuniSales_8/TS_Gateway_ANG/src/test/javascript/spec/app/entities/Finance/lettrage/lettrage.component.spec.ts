...
import { LettrageComponent } from 'app/entities/Finance/lettrage/lettrage.component';
...
describe('Component Tests', () => {
  describe('Lettrage Management Component', () => {
    let comp: LettrageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LettrageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lettrages && comp.lettrages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
